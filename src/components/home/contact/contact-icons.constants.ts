...
/** Width and height of the icons' shared coordinate system. */
export const ICON_VIEWBOX_SIZE = 16;

/**
 * Path data from Bootstrap Icons 1.13.1 (MIT): envelope, linkedin, github.
 * Every contact method must have an icon; a missing one is a compile error.
 */
export const CONTACT_ICON_PATHS: Readonly<Record<ContactMethod, string>> = {
  [ContactMethod.Email]:
