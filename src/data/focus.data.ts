...
/** What is being worked on right now; each item leads to the project that shows it. */
export const CURRENT_FOCUS: readonly FocusItem[] = [
  {
    ...
    detail: {
      [Locale.En]:
        'Research internship: how much of a model’s decision boundary its counterfactual explanations give away.',
      [Locale.Fr]:
        'Stage de recherche\u202F: ce que les explications contrefactuelles d’un modèle révèlent de sa frontière de décision.',
    },
    project: ProjectId.PolygonReconstruction,
  },
  {
    topic: {
    ...
    project: ProjectId.IsingMachine,
  },
];
