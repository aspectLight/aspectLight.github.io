...
/** The degree in progress; the feature row reads its dates and coursework. */
export const CURRENT_PROGRAM: EducationEntry = {
...
export const EDUCATION: readonly EducationEntry[] = [CURRENT_PROGRAM];
